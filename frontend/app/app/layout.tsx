...
import { Shield, BarChart, FileText, Settings, LogOut, Users, Server, Key, GitMerge } from "lucide-react";
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { href: "/app/products/secretguard", icon: Key, label: "SecretGuard" },
    { href: "/app/products/attackpath", icon: GitMerge, label: "AttackPath" },
